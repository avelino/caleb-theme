;;; caleb-theme.el --- Caleb Purple Theme

;; Copyright 2017, All rights reserved
;;
;; Code licensed under the MIT license
;; https://avelino.mit-license.org/

;; Author: avelino <thiago@avelino.xxx>
;; Version: 0.1
;; Package-Requires: ((emacs "24"))
;; URL: https://github.com/avelino/caleb-theme
;; Keywords: theme, dark

;;; Commentary:
;; Caleb, the purple turtle.
...
;; Emacs Rebecca: https://github.com/vic/rebecca-theme


(deftheme caleb "A purple, dark theme.")

(let* ((class '((class color) (min-colors 89)))
       (caleb "#663399")
       (ninja "#333353")

       (base00 (if (display-graphic-p) "#282a36" nil)) ;; default background
       (base01 (if (display-graphic-p) "#663399" "#8700d7")) ;; lighter background (status bar)
       (base02 (if (display-graphic-p) "#282a36" "#303030")) ;; selection background
       (base03 (if (display-graphic-p) "#6272a4" "#5f5faf")) ;; comments, invisibles
       (base04 (if (display-graphic-p) "#b6b6b2" "#afafaf")) ;; dark foreground (status bar)
       (base05 (if (display-graphic-p) "#f8f8f2" "#e4e4e4")) ;; default foreground
       (base06 (if (display-graphic-p) "#e2e2dc" "#d7d7d7")) ;; light foreground
       (base07 (if (display-graphic-p) "#53495d" "#4e4e4e")) ;; light background
       (base08 (if (display-graphic-p) "#a0a0c5" "#afafd7")) ;; variables
       (base09 (if (display-graphic-p) "#8be9fd" "#87d7ff")) ;; constants
       (base0A (if (display-graphic-p) "#ae81ff" "#af5fff")) ;; search text background
       (base0B (if (display-graphic-p) "#f1fa8c" "#ffff87")) ;; strings
       (base0C (if (display-graphic-p) "#ffb86c" "#ffaf5f")) ;; regex, escaped chars
       (base0D (if (display-graphic-p) "#50fa7b" "#5fff87")) ;; functions
       (base0E (if (display-graphic-p) "#ff79c6" "#ff87d7")) ;; keywords
       (base0F (if (display-graphic-p) "#ffb86c" "#ffaf5f")) ;; deprecations
  ...
  (custom-theme-set-faces
   ...
   ;; mode-line
   `(mode-line ((,class (:foreground ,type :background ,caleb))))
   ...
   ;; spacemacs
   `(spacemacs-normal ((,class (:background ,caleb))))
